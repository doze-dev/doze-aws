...
| Lambda | ✅ real process runtime (no Docker), versions, layers, function URLs, SQS/DynamoDB/Kinesis event source mappings | **fully audited**: 612/621 across all 47 routed operations with constrained input · 9 not expressible on the wire · no known gaps |
